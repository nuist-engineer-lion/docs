...
![](../../assets/legacy/images/SSD加速HHD/media/image1.png)
...
容量的选择需要谨慎，存储容量越大，炒豆子声音越大，如果你不知道买什么大小的合适，建议从4TB 开始
...
![](../../assets/legacy/images/SSD加速HHD/media/image2.png)
...
|注意：如果你希望使用这个技术，请务必完全阅读该块下的所有内容，你需要完全确认你的机器能够使用他|
---

#### M系列

M系列是非常老旧的系列，加速容量为 16GB 32GB 64GB，一般情况下你能购买到的容量为16GB ，价格非常便宜（20RMB），你可以在TB等电商平台轻松淘到
...
![](../../assets/legacy/images/SSD加速HHD/media/image3.png)

![](../../assets/legacy/images/SSD加速HHD/media/image4.png)
...
![](../../assets/legacy/images/SSD加速HHD/media/image5.png)

在状态视图你可以看到你的硬盘状态，确认你的傲腾硬盘在这上面

![](../../assets/legacy/images/SSD加速HHD/media/image6.png)

然后来到傲腾内存栏，尝试创建傲腾加速卷（由于我没有购买，演示到此结束）

![](../../assets/legacy/images/SSD加速HHD/media/image7.png)
...
![](../../assets/legacy/images/SSD加速HHD/media/image8.png)

在这里，你可以为一整个硬盘（无论是SSD还是HDD）设置缓存加速任务，也可以单独为一个磁盘分区设置缓存加速任务（对于一些特殊分区你可能需要进行颗粒度细一些的额外设置）

![](../../assets/legacy/images/SSD加速HHD/media/image9.png)
...
因为他会直接占用你设置的内存，如果你机器的内存本身不大，那么设置为1024MB / 2048MB 即可
...
![](../../assets/legacy/images/SSD加速HHD/media/image10.png)

点击Create Level-2 Storage 进入二级缓存创建页面，选择用于加速的硬盘（务必使用整块硬盘加速）

注意：这块硬盘的数据将被清除且无法另作他用

![](../../assets/legacy/images/SSD加速HHD/media/image11.png)
...
![](../../assets/legacy/images/SSD加速HHD/media/image12.png)

因为二级缓存使用一整个SSD进行加速，空间比较大，可以按需设置大一些

**R/W & Shared**

除了对一级、二级缓存的大小进行设置，还可以分别设置每个缓存的读缓存 和 写缓存 的大小
...
![](../../assets/legacy/images/SSD加速HHD/media/image13.png)
...
![](../../assets/legacy/images/SSD加速HHD/media/image14.png)

在这个示例中，总写入数据是30.77GB ，因为开启了缓写，数据将先进入缓存盘，然后逐步写入硬盘
