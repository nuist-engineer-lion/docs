...
![](../../assets/legacy/images/office/media/image1.png)

然后选择需要的应用，根据需求去安装需要的应用，不需要每次都最大安装。

![](../../assets/legacy/images/office/media/image2.png)

找到合适版本后再进行添加语言

![](../../assets/legacy/images/office/media/image3.png)

随后修改部署的方式

![](../../assets/legacy/images/office/media/image4.png)
...
![](../../assets/legacy/images/office/media/image10.png)
