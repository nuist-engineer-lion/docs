...
![](../../assets/legacy/images/VSCode/media/image1.png)

**(可选)** 安装**中文**语言包：按Ctrl+Shift+X，输入"Chinese"，点Install

![](../../assets/legacy/images/VSCode/media/image2.png)
...
![](../../assets/legacy/images/VSCode/media/image3.png)
...
![](../../assets/legacy/images/VSCode/media/image4.png)

![](../../assets/legacy/images/VSCode/media/image5.png)

### C/C++

如果有魔法，则采用Scoop安装，会方便很多，否则需要手动下载MinGw64。下面介绍两种情况的配置。

#### 有魔法的情况下，基于Scoop来安装环境
...
![](../../assets/legacy/images/VSCode/media/image6.png)
...
教程后两个步骤不需要变动。前两个步骤则需要手动下载gcc编译器。
...
可以采用上文提到的Scoop一键安装NodeJs：scoop install nodejs，也可以到官网<https://nodejs.org/>下载安装包

## 推荐的vsc插件

1. **CodeSnap**

   ![](../../assets/legacy/images/VSCode/media/image7.png)
