...
![mmexport9cc8ade521eba010cdb481f395dd8d74_16275322](../../assets/feishu/external/2c7e868d62c3f893323f0d8f.gif)
...
1. 相比普通笔记本电脑，苹果MacBook系列搭载的是macOS操作系统（其他的笔记本电脑一般搭载Windows操作系统），对于某些专业软件来说，可能无法在macOS操作系统上运行。ps: 对于苹果的早期机型，采用的是Intel处理器，因此早期的机型可以通过电脑自带的一个工具实现Windows的安装与运行，但现阶段Intel处理器的Macbook性价比不如苹果自研芯片。
