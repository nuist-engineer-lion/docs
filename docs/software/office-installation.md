...
![](../assets/feishu/media/8aa58f8205fea9165b1707c6.png)

然后选择需要的应用，根据需求去安装需要的应用，不需要每次都最大安装。

![](../assets/feishu/media/0a19e83cb42d7cf8255df354.png)

找到合适版本后再进行添加语言

![](../assets/feishu/media/f7266c2046320415309b9f51.png)

随后修改部署的方式

![](../assets/feishu/media/86bf5bcb7bdf9806363c1e45.png)
...
![](../assets/feishu/media/c50b7575a590be22f50730b8.png)

### 手动kms激活

在激活页面首先打开许可证管理，并点击安装许可证，从许可证列表中找出适合当前部署版本的许可证。

![](../assets/feishu/media/ab14b153a86934240336d002.png)

随后设置kms主机，可以从[kms列表](https://www.coolhub.top/tech-articles/kms_list.html)中找到合适的kms网址输入，然后点击设置主机即可使用kms。

![](../assets/feishu/media/a736d179b023e37f889780e4.png)

![](../assets/feishu/media/a676a0c27bd2cb1347cff47b.png)

最后再点击许可证管理右边的激活按钮即可完成激活，然后进入word中查看激活情况，以2019为例，先新疆一个word文档后点击工具栏上的文件，随后点击账户，看到以下信息就算激活成功。

![](../assets/feishu/media/299b63c6940a04e069e559ba.png)
...
![](../assets/feishu/media/31c99983b7ca72a17f74ceda.png)
